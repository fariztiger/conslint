      ...
      <div class="container">
        ...
        <div class="card tablelist-wrap">
          ...
          <div class="tablelist-content pad-v text-center text-info" v-if="!chartData.length">
            ...
            <div>Sentiment analysis data for each Polybees and Binance token based on loaded tweets.</div>
  ...
  computed: {
    ...
    sentimentInfoText() {
      ...
      if ( this.options.news.enabled && !this.priceData.length ) {
        return 'Currently waiting for tokens to load from the Polybees socket API...';
      }
